...
const defenseItems: CatalogItem[] = [
  {
    ...
    stats: { category: 'Оборона Астеров', attack: 900, life: 4_000, weaponType: 'Кинетика', armorType: 'Лёгкая броня', armorStrength: 4, specialization: 'Лёгкие цели', range: 'Орбита', priority: 'Перехват' },
  },
  {
    ...
    stats: { category: 'Оборона Астеров', attack: 1_250, life: 4_800, weaponType: 'Лазер', armorType: 'Лёгкая броня', armorStrength: 4, specialization: 'Универсальная', range: 'Орбита', priority: 'Флот' },
  },
  {
    ...
    stats: { category: 'Оборона Астеров', attack: 2_300, life: 7_000, weaponType: 'Ион', armorType: 'Средняя броня', armorStrength: 6, specialization: 'Щиты и броня', range: 'Орбита', priority: 'Крейсеры' },
  },
  {
    ...
    stats: { category: 'Оборона Астеров', attack: 4_500, life: 10_500, weaponType: 'Плазма', armorType: 'Средняя броня', armorStrength: 6, specialization: 'Тяжёлые цели', range: 'Дальняя орбита', priority: 'Линкоры' },
  },
  {
    id: 'laser-ion-battery', name: 'Лазерно-ионная батарея', role: 'Комбинированная батарея', art: laserIonBatteryArt, owned: 0,
    ...
    stats: { category: 'Оборона Астеров', attack: 8_200, life: 18_000, weaponType: 'Лазер / Ион', armorType: 'Средняя броня', armorStrength: 7, specialization: 'Универсальная', range: 'Дальняя орбита', priority: 'Флот' },
  },
  {
    id: 'plasma-laser-battery', name: 'Плазменно-лазерная батарея', role: 'Тяжёлая комбинированная батарея', art: plasmaLaserBatteryArt, owned: 0,
    ...
    stats: { category: 'Оборона Астеров', attack: 14_500, life: 29_000, weaponType: 'Плазма / Лазер', armorType: 'Тяжёлая броня', armorStrength: 9, specialization: 'Тяжёлые корабли', range: 'Дальняя орбита', priority: 'Линкоры' },
  },
  {
    id: 'ion-plasma-battery', name: 'Ионно-плазменная батарея', role: 'Штурмовая оборонная батарея', art: ionPlasmaBatteryArt, owned: 0,
    ...
    stats: { category: 'Оборона Астеров', attack: 22_000, life: 42_000, weaponType: 'Ион / Плазма', armorType: 'Тяжёлая броня', armorStrength: 10, specialization: 'Капитальные цели', range: 'Дальняя орбита', priority: 'Капитальные' },
  },
  {
    ...
    stats: { category: 'Оборона Астеров', attack: 1_000, life: 85_000, weaponType: 'Импульс', armorType: 'Щитовое поле', armorStrength: 14, specialization: 'Прикрытие обороны', range: 'Локальная', priority: 'Защита' },
  },
  {
    ...
    stats: { category: 'Оборона Астеров', attack: 4_000, life: 250_000, weaponType: 'Импульс', armorType: 'Планетарный щит', armorStrength: 18, specialization: 'Планетарная защита', range: 'Планета', priority: 'Защита' },
  },
];
