...
/*
 * Visual-only faction override for header QA.
 * Domain state is intentionally untouched; the current prototype remains Aegis.
 * Examples: ?headerFaction=aegis | synod | veyra
 */
